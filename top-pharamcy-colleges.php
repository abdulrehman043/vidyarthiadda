...
<body>
  ...
  <div class="my-3  d-flex flex-row row">
    <?php
    $query = 'SELECT  *FROM college_details WHERE code LIKE "%D12345%" OR code LIKE "%E12345%" OR code LIKE "%N12345%" OR code LIKE "%P12345%" OR code LIKE "%Q12345%"
    OR code LIKE "%R12345%" OR code LIKE "%U12345%" OR code LIKE "%W12345%"  OR code LIKE "%X12345%" OR code LIKE "%Z12345%" OR code LIKE "%DE6789%" OR code LIKE "%XY6789%"
    OR code LIKE "%DJ6789%" OR code LIKE "%QX6789%" OR code LIKE "%AZ6789%" OR code LIKE "%YU6789%" OR code LIKE "%AK6789%" OR code LIKE "%ED6789%"';

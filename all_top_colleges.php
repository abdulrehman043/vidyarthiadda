...
<body>
  ...
  <h1 class ="text-secondary">All Top  Colleges in Noida </h1>
    <?php
    $query = 'SELECT  *FROM college_details';
    ...
    <div class="card custom-card mx-2 my-2" style="z-index: 0;">
      <a href="<?php
      $idvar = $row['ID'];
      echo "../landing.php?" . $idvar ?> ">
        <img src="<?php echo $row['image']; ?>" class="card-img-top img-fluid mt-2" alt="..."></a>
        <a class="btn btn-warning w-100 my-2 font-weight-bold" href="../form.php" style="z-index: 2;">Apply Now</a>
        <a href="<?php
      $idvar = $row['ID'];
      echo "../landing.php?" . $idvar ?> ">
        <div class="card-body">

...
<body>
  ...
  <div class="my-3  d-flex flex-row row">
    <?php
    $query = 'SELECT  *FROM college_details WHERE code LIKE "%F12345%" OR code LIKE "%M12345%" OR code LIKE "%O12345%" OR code LIKE "%UV6789%" OR code LIKE "%FS6789%"
    OR code LIKE "%KL6789%" OR code LIKE "%CS6789%"';

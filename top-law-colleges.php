...
<script>
  ...
  <div class="my-3  d-flex flex-row row">
    <?php
    $query = 'SELECT  *FROM college_details WHERE code LIKE "%B12345%" OR code LIKE "%H12345%" OR code LIKE "%J12345%" OR code LIKE "%AB6789%" OR code LIKE "%BC6789%"
    OR code LIKE "%EF6789%" OR code LIKE "%GH6789%"';
